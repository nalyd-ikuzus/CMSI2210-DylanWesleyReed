...
dec2hex 1073746484 64               >> testresults.txt
echo . >> testresults.txt
...
timesTables 21                      >> testresults.txt
echo . >> testresults.txt
...
wordcount input.txt                 >> testresults.txt
